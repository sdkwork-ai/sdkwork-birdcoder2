...
import {
  ...
  hostOpenTerminalRequestSchema, hostPickDirectoryRequestSchema,
...
import {
  agentPresetListRequestSchema, agentPresetSelectRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.openTerminal': { schema: hostOpenTerminalRequestSchema, invoke: (api, r, signal) => api.host.openTerminal(r, signal) },
