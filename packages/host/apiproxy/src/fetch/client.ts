...
import {
  ...
  hostListDirectoryValueSchema, hostOpenPathValueSchema,
  hostOpenTerminalValueSchema, hostPickDirectoryValueSchema,
...
import {
  agentPresetListValueSchema, agentPresetSelectValueSchema,
...
export interface IApiClient {
  ...
  host: {
    ...
    openTerminal(payload: RequestPayload<'host.openTerminal'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.openTerminal'>>>
  }
  workspace: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'host.openTerminal': hostOpenTerminalValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    openTerminal: (payload, signal) => this.callUnary('host.openTerminal', payload, signal),
  }
