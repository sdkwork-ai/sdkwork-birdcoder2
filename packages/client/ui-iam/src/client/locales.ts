/** ui-iam dictionaries: the account mode, its rail entry, and the surfaces. */

/** Simplified Chinese dictionary (the key-set source of truth). */
export const zh = {
  'page.title': '账号',
  'page.unconfigured.title': '未配置 IAM 服务',
  'page.unconfigured.detail': '请在设置中配置 ui-env 的环境 baseUrl 后使用账号登录。',
...
/** The ui-iam namespace key union. */
...
export const en = {
  ...
  'page.unconfigured.detail': 'Configure the ui-env environment baseUrl in settings to sign in with your SDKWork account.',
