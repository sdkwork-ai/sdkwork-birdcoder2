...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'ui-sdkwork-generations-image: dictionaries')
  ...
  ctx.effect(() => () => { adapter.dispose() }, 'ui-sdkwork-generations-image: SDKWork creative host adapter')
