...
const base = clientBundle('@deepseek-ai/dsh-client-ui-sdkwork-generations-image', ['lib/types/index.js', 'lib/types/invariant.js'])
...
function virtualStyleModule(id: string, css: string): string {
  return [
    ...
    "  tag.dataset.plugin = '@deepseek-ai/dsh-client-ui-sdkwork-generations-image';",
  ...
  plugins: [
    ...
    createSdkworkBrowserBuiltinsPlugin('dsh-creative-browser-builtins', BROWSER_BUILTIN_PREFIX, VIRTUAL_SUFFIX),
    {
      ...
      async load(this: ResolverContext, id: string) {
        ...
        return virtualStyleModule('@deepseek-ai/dsh-client-ui-sdkwork-generations-image/creative-index.css', compiled)
      },
    },
    {
      ...
      async load(this: ResolverContext, id: string) {
        ...
        return virtualStyleModule(
          '@deepseek-ai/dsh-client-ui-sdkwork-generations-image/' + cssPath,
