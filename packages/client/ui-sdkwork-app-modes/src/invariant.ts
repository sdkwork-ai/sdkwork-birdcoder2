/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-sdkwork-app-modes`.
 * @module @deepseek-ai/dsh-client-ui-sdkwork-app-modes/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-sdkwork-app-modes'

/** Cordis companion plugin name. */
export const name = 'client-ui-sdkwork-app-modes-invariant'
