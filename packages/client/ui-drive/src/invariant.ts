/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-drive`.
 * @module @deepseek-ai/dsh-client-ui-drive/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-drive'

/** Cordis companion plugin name. */
export const name = 'client-ui-drive-invariant'
