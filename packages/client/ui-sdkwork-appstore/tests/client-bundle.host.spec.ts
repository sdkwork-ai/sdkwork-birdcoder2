...
describe('ui-sdkwork-appstore client bundle', () => {
  it('inlines SDKWork packages and avoids Node built-in loader externals', () => {
    ...
    if (!existsSync(bundlePath)) {
      throw new Error('ui-sdkwork-appstore lib/client.js is missing — run pnpm --filter @deepseek-ai/dsh-client-ui-sdkwork-appstore run bundle')
    }
