 ...
 *
 * The checksum is the shipped one rather than a second implementation, so a
 * fixture can never disagree with the writer about what a CRC-32 is.
 */
import { crc32 } from '@deepseek-ai/dsh-client-sdkwork-office'
