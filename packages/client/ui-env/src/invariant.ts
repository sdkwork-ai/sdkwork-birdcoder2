/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-env`.
 * @module @deepseek-ai/dsh-client-ui-env/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-env'

/** Cordis companion plugin name. */
export const name = 'client-ui-env-invariant'
