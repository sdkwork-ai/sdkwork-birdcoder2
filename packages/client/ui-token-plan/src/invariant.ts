 ...
 * @module @deepseek-ai/dsh-client-ui-token-plan/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-token-plan'

/** Cordis companion plugin name. */
export const name = 'client-ui-token-plan-invariant'
