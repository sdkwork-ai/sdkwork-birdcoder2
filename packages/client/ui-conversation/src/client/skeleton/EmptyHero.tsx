...
/**
 * The hero brand mark (34px): the BirdCoder raster via the shared BirdLogo
 * component. FORK-OWNED SURFACE: upstream falls back to its animated fish
 * morph here; this fork always shows the BirdCoder mark (see AGENTS.md,
 * "BirdCoder brand assets"). Resolve fork-first on upstream merges.
 * @returns the brand mark element.
 */
function HeroBrandMark() {
  return <BirdLogo size={34} className={css.fish} />
}
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* Brand mark 34px leading the headline, gap 10. */}
