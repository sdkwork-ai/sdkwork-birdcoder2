/** ui-appstore apply wiring: the rail entry and the SDKWork page, each keyed
...
import { apply, inject } from '@deepseek-ai/dsh-client-ui-appstore/client'
import type {
  AppStorePageInjected, AppStoreRailEntryInjected,
} from '@deepseek-ai/dsh-client-ui-appstore/client'
