/** ui-sdkwork-drive apply wiring: the rail entry and the SDKWork page, each keyed by
...
import { apply, inject } from '@deepseek-ai/dsh-client-ui-sdkwork-drive/client'
import type {
  DrivePageInjected, DriveRailEntryInjected,
} from '@deepseek-ai/dsh-client-ui-sdkwork-drive/client'
...
describe('ui-sdkwork-drive apply', () => {
