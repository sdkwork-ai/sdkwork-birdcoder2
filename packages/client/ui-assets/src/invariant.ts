/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-assets`.
 * @module @deepseek-ai/dsh-client-ui-assets/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-assets'

/** Cordis companion plugin name. */
export const name = 'client-ui-assets-invariant'
