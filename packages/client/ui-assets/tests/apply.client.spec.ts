/** ui-assets apply wiring: the rail entry and the placeholder page, each
...
import { apply, inject } from '@deepseek-ai/dsh-client-ui-assets/client'
import type {
  AssetsPageInjected, AssetsRailEntryInjected,
} from '@deepseek-ai/dsh-client-ui-assets/client'
