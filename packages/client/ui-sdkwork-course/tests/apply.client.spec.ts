...
import { apply, inject } from '@deepseek-ai/dsh-client-ui-sdkwork-course/client'
import type {
  CoursePageInjected, CourseRailEntryInjected,
} from '@deepseek-ai/dsh-client-ui-sdkwork-course/client'
...
describe('ui-sdkwork-course apply', () => {
