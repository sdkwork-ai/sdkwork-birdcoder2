...
import {
  CENTER_MIN, clampWidth, computeColumns, MODE_RAIL_WIDTH, RIGHTBAR_DEFAULT_RATIO, RIGHTBAR_MAX_RATIO,
  RIGHTBAR_MIN, SIDEBAR_AUTO_COLLAPSE, SIDEBAR_COLLAPSED, SIDEBAR_DEFAULT,
} from './columns.ts'
...
export function AppFrame({
  ...
  const normal = computeColumns(solvable, !layoutInfo.rightbarShown && narrow ? 0 : sidebarPreference, rightbarPreference, collapsedWidth)
  const cols = computeColumns(solvable, sidebarPreference, codeMode && layoutInfo.rightbarTrack ? rightbarPreference : 0, collapsedWidth)
  ...
  return (
    <div
      ...
      style={{
        ...
        gridTemplateColumns:
          `${MODE_RAIL_WIDTH}px ${sidebarVisible ? cols.sidebar : 0}px minmax(${cols.rightbar === 0 ? 0 : CENTER_MIN}px, 1fr) minmax(0px, ${rightbarMax}px)`,
      }}
