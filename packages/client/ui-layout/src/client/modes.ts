 ...
 * mode rail entries, their labels, and the placeholder pages are the
 * app-mode feature modules' concern — each mode's rail entry and page is
 * contributed by its own plugin package.
 */
