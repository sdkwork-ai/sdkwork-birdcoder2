...
import { apply, inject } from '@deepseek-ai/dsh-client-ui-sdkwork-iam/client'
...
async function bench(settings: Partial<UiIamSettings> = {}, envProfile: Partial<{ apiBaseUrl: string; appId: string }> = {}) {
  // The initial environment is explicitly unconfigured: the ui-sdkwork-env default is
...
describe('ui-sdkwork-iam client plugin', () => {
