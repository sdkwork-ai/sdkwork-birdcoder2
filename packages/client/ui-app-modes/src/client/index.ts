...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'ui-app-modes: dictionaries')
  ...
  // The sidebar-visibility preference: mirror the `ui-app-modes` scope into
  ...
  ctx.effect(
    ...
    'ui-app-modes: sidebar settings row mirror',
  )
  ...
  }), 'ui-app-modes: sidebar visibility boot default')
