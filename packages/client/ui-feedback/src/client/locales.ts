/** ui-feedback dictionaries: the dialog form, its states, and the dialog shell. */
...
export const zh = {
  ...
  'dialog.unconfigured.detail': '请在设置中配置 ui-env 的环境 baseUrl 后提交反馈。',
  'dialog.type': '反馈类型',
...
/** The ui-feedback namespace key union. */
...
export const en = {
  ...
  'dialog.unconfigured.detail': 'Configure the ui-env environment baseUrl in settings to submit feedback.',
