/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-course`.
 * @module @deepseek-ai/dsh-client-ui-course/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-course'

/** Cordis companion plugin name. */
export const name = 'client-ui-course-invariant'
