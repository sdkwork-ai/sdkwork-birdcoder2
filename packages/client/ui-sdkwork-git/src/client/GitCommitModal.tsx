...
import { CloudUpload, GitBranch, Sparkles, Square, X } from 'lucide-react'
    ...
    >
      <div className={css.commitBody}>
        <div className={css.commitHeader}>
          ...
          {/* The headless Modal ships no built-in close affordance — Escape
              and the mask still close the dialog, but discoverability matters
              here, so a small X button rides on the right of the header. */}
          <button
            type="button"
            className={css.commitClose}
