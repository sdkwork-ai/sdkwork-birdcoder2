...
export const zh = {
  ...
  'menu.desktopPlugins': '桌面插件…',
  'menu.desktopPlugins.packagedOnly': '桌面插件…（打包应用中可用）',
  'menu.quitApp': '退出应用',
  'menu.signIn': '登录 / 注册',
...
export const en = {
  ...
  'menu.desktopPlugins': 'Desktop Plugins…',
  'menu.desktopPlugins.packagedOnly': 'Desktop Plugins… (available in packaged applications)',
  'menu.quitApp': 'Quit',
