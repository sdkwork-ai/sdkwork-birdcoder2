...
export type TriggerContentProps = PropsRuntime<'settings.trigger'> & PropsLocale<'settings.menu'>

/** Header content props: the standard locale seat only. */
export type HeaderContentProps = PropsRuntime<'settings.header'> & PropsLocale<'settings.menu'>
...
export type CloseLabelProps = PropsRuntime<'settings.close'> & PropsLocale<'settings.menu'>
