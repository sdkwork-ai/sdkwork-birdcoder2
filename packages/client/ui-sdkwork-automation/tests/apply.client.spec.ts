/** ui-sdkwork-automation apply wiring: the sidebar quick entry and the
 * page (view tabs, empty states, template catalog) keyed by the `automation`
...
import { apply, inject } from '@deepseek-ai/dsh-client-ui-sdkwork-automation/client'
import type {
  AutomationActionInjected, AutomationPageInjected,
