...
import type { FeedbackRuntime, FeedbackSource } from '@deepseek-ai/dsh-client-ui-sdkwork-settings-menu/client'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'ui-sdkwork-feedback: dictionaries')

  // The IAM service is optional: absent (no ui-sdkwork-iam mount) submissions still
  ...
  ctx.effect(() => service.subscribeIam(), 'ui-sdkwork-feedback: iam token sync')
