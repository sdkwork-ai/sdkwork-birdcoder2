...
describe('ui-sdkwork-env host settings registration', () => {
  it('registers the ui-sdkwork-env namespace against the real settings-file provider', async () => {
    const home = await mkdtemp(join(tmpdir(), 'dsh-ui-sdkwork-env-host-'))
