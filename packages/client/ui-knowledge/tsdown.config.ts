  ...
  plugins: [
    ...
    createSdkworkBrowserBuiltinsPlugin('dsh-knowledge-browser-builtins', BROWSER_BUILTIN_PREFIX, VIRTUAL_SUFFIX),
    {
      ...
      async resolveId(this: ResolverContext, source: string, importer: string | undefined) {
        ...
        if (resolved === null) throw new Error('ui-knowledge: pdf.js worker module is not resolvable')
    ...
    },
    {
      ...
      async load(this: ResolverContext, id: string) {
        ...
        return virtualStyleModule('@deepseek-ai/dsh-client-ui-knowledge/knowledgebase-index.css', compiled)
      },
    },
    {
      ...
      async load(this: ResolverContext, id: string) {
        ...
        return virtualStyleModule('@deepseek-ai/dsh-client-ui-knowledge/' + cssPath, await readFile(cssPath, 'utf8'))
      },
    },
  ],
}))
