...
function virtualStyleModule(id: string, css: string): string {
  return [
    ...
    "  tag.dataset.plugin = '@deepseek-ai/dsh-client-ui-sdkwork-generations-assets';",
  ...
  plugins: [
    ...
    createSdkworkBrowserBuiltinsPlugin('dsh-assets-browser-builtins', BROWSER_BUILTIN_PREFIX, VIRTUAL_SUFFIX),
    {
      ...
      async load(this: ResolverContext, id: string) {
        ...
        return virtualStyleModule('@deepseek-ai/dsh-client-ui-sdkwork-generations-assets/assets-index.css', compiled)
      },
    },
    {
      ...
      async load(this: ResolverContext, id: string) {
        ...
        return virtualStyleModule(
          '@deepseek-ai/dsh-client-ui-sdkwork-generations-assets/' + cssPath,
