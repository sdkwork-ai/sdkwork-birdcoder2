...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-sdkwork-window-controls WindowControls id \'window-controls\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-sdkwork-window-controls TraySettingsRow id \'desktop-tray\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-common-app-header AppHeader',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'shell.app-header.actions',
    kind: 'list',
    scope: 'root',
    summary: 'Additive trailing actions beside the window-control spacer (refresh, help, mode-specific utilities).',
    doc: 'Additive trailing actions beside the window-control spacer (refresh,\nhelp, mode-specific utilities).',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'shell.app-header\' (client-ui-sdkwork-common-app-header), so it exists while that entry is mounted',
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.app-header.actions\', () => ctx.slots.register(\n      { name: \'shell.app-header.actions\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sdkwork-common-app-header/src/client/index.ts:37',
  },
  {
    key: 'shell.app-header.leading',
    kind: 'keyed',
    scope: 'root',
    summary: 'Optional keyed leading chrome per non-code mode (icon, badge).',
    doc: 'Optional keyed leading chrome per non-code mode (icon, badge). The\nheader dispatches by the active mode id; absent a contribution the seat\nrenders empty and the title stands alone.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.app-header.leading\', () => ctx.slots.register(\n      { name: \'shell.app-header.leading\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sdkwork-common-app-header/src/client/index.ts:32',
  },
  {
    key: 'shell.overlay',
    kind: 'list',
    ...
    occupants: [
      ...
      'client-ui-sdkwork-window-controls FloatingWindowControls id \'window-controls-floating\'',
    ],
    replaceRisk: 'none',
