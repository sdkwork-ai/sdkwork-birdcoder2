...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-window-controls WindowControls id \'window-controls\'',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: account, appstore, assets, drive, image, knowledge, token-plan, video',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-app-modes ModePage',
      'client-ui-appstore AppStorePage key \'appstore\'',
      'client-ui-assets AssetsPage key \'assets\'',
      'client-ui-drive DrivePage key \'drive\'',
      'client-ui-generations-assets AssetsPage key \'assets\'',
      'client-ui-generations-image ImageGenerationsPage key \'image\'',
      'client-ui-generations-video VideoGenerationsPage key \'video\'',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: appstore, assets, drive, image, knowledge, token-plan, video',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'client-ui-appstore AppStoreRailEntry key \'appstore\'',
      'client-ui-assets AssetsRailEntry key \'assets\'',
      'client-ui-drive DriveRailEntry key \'drive\'',
      'client-ui-generations-assets AssetsGenerationsRailEntry key \'assets\'',
      'client-ui-generations-image ImageGenerationsRailEntry key \'image\'',
      'client-ui-generations-video VideoGenerationsRailEntry key \'video\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-updater UpdateSettingsRow id \'desktop-update\'',
      'client-ui-window-controls TraySettingsRow id \'desktop-tray\'',
    ],
    replaceRisk: 'none',
