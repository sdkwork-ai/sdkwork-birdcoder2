...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-sdkwork-app-modes SceneSkillTags id \'hero-scene-skills\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'factory \'conversation.content\' (client-ui-conversation), so it exists while that definition is registered',
    occupants: [
      'client-ui-sdkwork-app-modes HeroSceneSkillTags id \'hero-scene-skills-cold\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.hero.modeSwitch',
    kind: 'single',
    scope: 'root',
    summary: 'Scene switcher staged under the blank-session headline.',
    doc: 'Scene switcher staged under the blank-session headline.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'factory \'conversation.content\' (client-ui-conversation), so it exists while that definition is registered',
    occupants: [
      'client-ui-sdkwork-app-modes HeroModeSwitch',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.session.header.surface',
    kind: 'single',
    scope: 'session',
    summary: 'Optional replacement for the full Session header body.',
    doc: 'Optional replacement for the full Session header body.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-conversation-header SdkworkConversationHeader',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.session.header.surface\', () => ctx.slots.register(\n      { name: \'conversation.session.header.surface\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-sdkwork-deploy DeployPublishAction id \'sdkwork-deploy-publish\'',
      'client-ui-sdkwork-git GitBranchPill id \'sdkwork-git-branch-pill\'',
      'client-ui-sdkwork-share ShareAction id \'sdkwork-share\'',
      'client-ui-sdkwork-workspace-row-menus BuildIndicator id \'sdkwork-app-build-indicator\'',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: account, appstore, assets, automation, course, drive, image, knowledge, markets, pull-request, token-plan, video',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-app-modes ModePage',
      'client-ui-sdkwork-appstore AppStorePage key \'appstore\'',
      'client-ui-sdkwork-assets AssetsPage key \'assets\'',
      'client-ui-sdkwork-automation AutomationPage key \'automation\'',
      'client-ui-sdkwork-course CoursePage key \'course\'',
      'client-ui-sdkwork-drive DrivePage key \'drive\'',
      'client-ui-sdkwork-generations-assets AssetsPage key \'assets\'',
      'client-ui-sdkwork-generations-image ImageGenerationsPage key \'image\'',
      'client-ui-sdkwork-generations-video VideoGenerationsPage key \'video\'',
      'client-ui-sdkwork-git-pullrequest PullRequestPage key \'pull-request\'',
      'client-ui-sdkwork-iam AccountModePage key \'account\'',
      'client-ui-sdkwork-knowledge KnowledgePage key \'knowledge\'',
      'client-ui-sdkwork-markets MarketsPage key \'markets\'',
      'client-ui-sdkwork-token-plan TokenPlanPage key \'token-plan\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-app-modes ModeRail',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: appstore, assets, course, drive, image, knowledge, token-plan, video',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'mode.rail\' (client-ui-sdkwork-app-modes), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-app-modes RailEntry',
      'client-ui-sdkwork-appstore AppStoreRailEntry key \'appstore\'',
      'client-ui-sdkwork-assets AssetsRailEntry key \'assets\'',
      'client-ui-sdkwork-course CourseRailEntry key \'course\'',
      'client-ui-sdkwork-drive DriveRailEntry key \'drive\'',
      'client-ui-sdkwork-generations-assets AssetsGenerationsRailEntry key \'assets\'',
      'client-ui-sdkwork-generations-image ImageGenerationsRailEntry key \'image\'',
      'client-ui-sdkwork-generations-video VideoGenerationsRailEntry key \'video\'',
      'client-ui-sdkwork-knowledge KnowledgeRailEntry key \'knowledge\'',
      'client-ui-sdkwork-token-plan TokenPlanRailEntry key \'token-plan\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'mode.rail.entry\', () => ctx.slots.register(\n      { name: \'mode.rail.entry\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sdkwork-app-modes/src/client/contract/slots.ts:20',
  },
  {
    ...
    declaredBy: 'an entry in \'mode.rail\' (client-ui-sdkwork-app-modes), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-settings-menu SettingsMenuRoot',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'mode.rail.settings\', () => ctx.slots.register(\n      { name: \'mode.rail.settings\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sdkwork-app-modes/src/client/contract/slots.ts:29',
  },
  {
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'mode.rail.settings\' (client-ui-sdkwork-settings-menu), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-settings-menu SettingsDocumentAction id \'open-document\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'mode.rail.settings\' (client-ui-sdkwork-settings-menu), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-apikey ApiKeysModal',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.apiKeys\', () => ctx.slots.register(\n      { name: \'settings.apiKeys\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:103',
  },
  {
    key: 'settings.close',
    kind: 'single',
    ...
    declaredBy: 'an entry in \'mode.rail.settings\' (client-ui-sdkwork-settings-menu), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-settings-menu CloseLabel',
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'settings.section\' (client-ui-sdkwork-settings-menu), so it exists while that entry is mounted',
    occupants: [
      ...
      'client-ui-sdkwork-app-modes SidebarSettingsRow id \'app-modes-sidebar\'',
      'client-ui-sdkwork-updater UpdateSettingsRow id \'desktop-update\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'mode.rail.settings\' (client-ui-sdkwork-settings-menu), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-settings-menu HeaderContent',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-sdkwork-settings-menu GeneralSection id \'general\'',
      'client-ui-sdkwork-skills SkillsSection id \'skills\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'mode.rail.settings\' (client-ui-sdkwork-settings-menu), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-settings-menu TriggerContent',
  ...
  },
  {
    ...
    source: 'packages/client/ui-layout/src/client/index.ts:143',
  },
  {
    key: 'shell.overlay',
    kind: 'list',
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-feedback FeedbackDialog id \'feedback\'',
      'client-ui-sdkwork-iam SignInOverlay id \'iam-sign-in\'',
      'client-ui-sdkwork-mobile-simulator MobileSimulator key \'mobile-simulator-inline\'',
      'client-ui-sdkwork-mobile-simulator MobileSimulator key \'mobile-simulator-modal\'',
      'client-ui-sdkwork-updater UpdateBanner id \'update-banner\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-common-app-header WindowTitle',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-sdkwork-automation AutomationAction id \'sdkwork-automation\'',
      'client-ui-sdkwork-git-pullrequest PullRequestAction id \'sdkwork-git-pullrequest\'',
      'client-ui-sdkwork-markets MarketsAction id \'sdkwork-markets\'',
      'client-ui-sdkwork-new-chat NewChatAction id \'sdkwork-new-chat\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.actions\', () => ctx.slots.register(\n      { name: \'sidebar.actions\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-sdkwork-audio-preview AudioPlayer',
      'client-ui-sdkwork-docx-preview DocxBody',
      'client-ui-sdkwork-image-preview ImageViewer',
      'client-ui-sdkwork-pdf-preview PdfBody',
      'client-ui-sdkwork-pptx-preview PptxBody',
      'client-ui-sdkwork-video-preview VideoPreviewBody',
      'client-ui-sdkwork-xlsx-preview XlsxBody',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sdkwork-workspace-row-menus RowMenusEntry id \'sdkwork-row-menus\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.rowMenus\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.rowMenus\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:145',
  },
  {
