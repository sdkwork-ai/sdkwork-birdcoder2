...
|---|---|---|---|---|
| dsh | version: `packages/*/*` + `apps/*`; npm publish: all except private `apps/desktop` | one version for the family and the workspace root, `0.0.x` | `dsh-v<version>` | `release.yml` |
