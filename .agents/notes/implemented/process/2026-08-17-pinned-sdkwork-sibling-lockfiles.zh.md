...
兄弟仓库设置 action 以不可变提交检出每个仓库，根目录 `pnpm-lock.yaml` 按这些确切的兄弟仓库 manifest 维护。appbase 固定提交为 `7455ba839f2b7aed6fd7c437d1093628f08fa4d2`；该提交中的 foundation 包不声明 backend SDK，backend SDK importer 使用与该提交匹配的 workspace 依赖规格。
