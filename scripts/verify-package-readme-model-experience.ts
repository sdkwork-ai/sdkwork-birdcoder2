...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-sdkwork-app-modes': { kind: 'none', reason: 'Browser-side mode rail, placeholder pages, and a settings preference; switching modes changes viewing state only.' },
  'packages/client/ui-sdkwork-appstore': { kind: 'none', reason: 'Browser-side SDKWork App Store catalog; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-feedback': { kind: 'none', reason: 'Browser-side SDKWork feedback dialog; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-iam': { kind: 'none', reason: 'Browser-side SDKWork IAM sign-in and account surface; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-generations-image': { kind: 'none', reason: 'Browser-side SDKWork generations UI; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-generations-assets': { kind: 'none', reason: 'Browser-side SDKWork asset library UI; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-generations-video': { kind: 'none', reason: 'Browser-side SDKWork generations UI; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-token-plan': { kind: 'none', reason: 'Browser-side SDKWork membership and order commerce UI; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-env': { kind: 'none', reason: 'Browser-side shared SDKWork deployment settings; consumers own every resulting request.' },
  'packages/client/ui-sdkwork-settings-menu': { kind: 'none', reason: 'Browser-side settings chrome and navigation; registers nothing model-facing.' },
  'packages/client/ui-sdkwork-knowledge': { kind: 'none', reason: 'Browser-side SDKWork Knowledge Base application; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-course': { kind: 'none', reason: 'Browser-side SDKWork Course application; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-drive': { kind: 'none', reason: 'Browser-side SDKWork Drive application; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-sdkwork-assets': { kind: 'none', reason: 'Browser-side mode entry and placeholder page; switching modes changes viewing state only.' },
  ...
  'packages/client/ui-sdkwork-conversation-header': { kind: 'none', reason: 'Browser-side header presentation; the stores beneath it (sessions, conversation views) own every fact it renders.' },
  ...
  'packages/client/sdkwork-office': { kind: 'none', reason: 'Browser-side OOXML library shared by the document previews; registers no tool, prompt section, or session event.' },
  'packages/client/ui-sdkwork-pptx-preview': { kind: 'none', reason: 'Browser-only PowerPoint viewer; registers no tool, prompt section, or session event, and what the user reads never enters a model request.' },
  'packages/client/ui-sdkwork-docx-preview': { kind: 'none', reason: 'Browser-only Word viewer; registers no tool, prompt section, or session event, and what the user reads never enters a model request.' },
  'packages/client/ui-sdkwork-xlsx-preview': { kind: 'none', reason: 'Browser-only Excel viewer; registers no tool, prompt section, or session event, and what the user reads never enters a model request.' },
  'packages/client/ui-sdkwork-pdf-preview': { kind: 'none', reason: 'Browser-only PDF viewer; registers no tool, prompt section, or session event, and what the user reads never enters a model request.' },
  'packages/client/ui-sdkwork-image-preview': { kind: 'none', reason: 'Browser-only image viewer; registers no tool, prompt section, or session event, and what the user reads never enters a model request.' },
  'packages/client/ui-sdkwork-video-preview': { kind: 'none', reason: 'Browser-only video player; registers no tool, prompt section, or session event, and what the user watches never enters a model request.' },
  'packages/client/ui-sdkwork-audio-preview': { kind: 'none', reason: 'Browser-only audio player; registers no tool, prompt section, or session event, and what the user hears never enters a model request.' },
  ...
  'packages/host/sdkwork-desktop-carrier': { kind: 'none', reason: 'The carrier dispatches app:// requests to host handlers and registers nothing model-facing.' },
  ...
  'packages/skill/sdkwork-builtin-skills': { kind: 'indirect', reason: 'The bundled directory root contributes catalog entries and bodies; dsh-tool-skill owns their rendering.' },
  ...
  'packages/boot/sdkwork-env-bootstrap': { kind: 'none', reason: 'Host-side bootstrap env glue; it writes a gitignored overlay and registers nothing model-facing.' },
