...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-app-modes': { kind: 'none', reason: 'Browser-side mode rail, placeholder pages, and a settings preference; switching modes changes viewing state only.' },
  'packages/client/ui-appstore': { kind: 'none', reason: 'Browser-side SDKWork App Store catalog; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-feedback': { kind: 'none', reason: 'Browser-side SDKWork feedback dialog; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-iam': { kind: 'none', reason: 'Browser-side SDKWork IAM sign-in and account surface; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-generations-image': { kind: 'none', reason: 'Browser-side SDKWork generations UI; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-generations-assets': { kind: 'none', reason: 'Browser-side SDKWork asset library UI; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-generations-video': { kind: 'none', reason: 'Browser-side SDKWork generations UI; its business HTTP requests remain separate from Harness model requests.' },
  'packages/client/ui-token-plan': { kind: 'none', reason: 'Browser-side SDKWork membership and order commerce UI; its business HTTP requests remain separate from Harness model requests.' },
  ...
  'packages/client/ui-window-controls': { kind: 'none', reason: 'Desktop chrome and session navigation; user actions do not submit a message or change a model request.' },
  'packages/client/ui-updater': { kind: 'none', reason: 'Desktop update presentation and preferences; the package adds no session event and changes no model request.' },
  ...
  'packages/host/desktop-carrier': { kind: 'none', reason: 'The carrier dispatches app:// requests to host handlers and registers nothing model-facing.' },
