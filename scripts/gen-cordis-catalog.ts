...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  directoryPickerController: 'workspace.md',  sdkworkAppBuild: 'extensions.md',
  sdkworkAppBuildController: 'extensions.md',
  sdkworkGit: 'extensions.md',
  sdkworkGitController: 'extensions.md',
  apiProxy: 'web-server.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  sdkworkApiFallback: 'fork slot service (interface SdkworkApiFallback) — packages/host/sdkwork-api-gateway/README.md owns the API',
  sdkworkEventUpgrades: 'fork slot service (interface SdkworkEventUpgrades) — packages/host/sdkwork-api-gateway/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  // SDKWork API controllers: request/value contracts are owned by each
  // controller package's README, outside the subsystems catalog.
  SdkworkAppBuildStartRequest: 'owned by packages/api/sdkwork-app-build-controller/README.md',
  SdkworkAppBuildStartValue: 'owned by packages/api/sdkwork-app-build-controller/README.md',
  ...
  SdkworkGitBranches: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitBranchesRequest: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitCheckoutRequest: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitCheckoutValue: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitCreateRequest: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitCreateValue: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitLog: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitLogRequest: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitCommitRequest: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitCommitValue: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitPushRequest: 'owned by packages/api/sdkwork-git-controller/README.md',
  SdkworkGitPushValue: 'owned by packages/api/sdkwork-git-controller/README.md',
