...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SdkworkAppBuildStartRequest: 'app-build request contract is owned by packages/host/sdkwork-app-build/README.md',
  SdkworkAppBuildStartValue: 'app-build start result is owned by packages/host/sdkwork-app-build/README.md',
  SdkworkAppBuildFrame: 'app-build event frame is owned by packages/host/sdkwork-app-build/README.md',
  SdkworkAppBuildCancelRequest: 'app-build request contract is owned by packages/host/sdkwork-app-build/README.md',
  SdkworkAppBuildCancelValue: 'app-build cancel result is owned by packages/host/sdkwork-app-build/README.md',
  SdkworkAppBuildStatus: 'app-build point-in-time status is owned by packages/host/sdkwork-app-build/README.md',
