...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  account: 'client-side interface-typed browser service — packages/client/ui-sdkwork-settings-menu/README.md owns the API',
  ...
  feedback: 'client-side interface-typed browser service — packages/client/ui-sdkwork-settings-menu/README.md owns the API',
