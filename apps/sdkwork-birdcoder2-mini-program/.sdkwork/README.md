...
This `.sdkwork/` directory is source-controlled workspace metadata for `sdkwork-birdcoder2-mini-program`.

It is governed by `../../sdkwork-specs/SDKWORK_WORKSPACE_SPEC.md`.

## Application Identity

- App: sdkwork-birdcoder2-mini-program
- Type: weixin-mini-program-app
- Domain: ai
...
- Architecture standard: `../../sdkwork-specs/MINI_PROGRAM_APP_ARCHITECTURE_SPEC.md`
