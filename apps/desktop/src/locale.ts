...
export const en = {
  ...
  aboutMenu: 'About BirdCoder',
  aboutProduct: 'BirdCoder',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide BirdCoder',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  fileMenu: '文件',
  closePage: '关闭页面或窗口',
  aboutMenu: '关于 BirdCoder',
  aboutProduct: 'BirdCoder',
  edit: 'Edit',
  ...
  startupFailed: 'BirdCoder is unavailable',
  fatalSummary: 'The application could not start or stopped unexpectedly.',
  startupAddressInUse: 'Another BirdCoder instance (such as dsh web or the desktop app) is running. They cannot start at the same time. Quit the other running BirdCoder instance, then restart.',
  ...
  welcomeTitle: 'BirdCoder',
  welcomeBrand: 'BirdCoder',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'BirdCoder',
  welcomeTaglineAfter: '',
  ...
  welcomeKeyDescription: 'Configure official DeepSeek models to start using BirdCoder',
  ...
  updateDownloadedTitle: 'BirdCoder v{version} downloaded',
  ...
  updateDetail: 'BirdCoder {version}\n\nBirdCoder will restart to complete the update.',
...
export const zh = {
  application: '应用',
  quitApplication: 'Quit BirdCoder',
  openApplication: 'Open BirdCoder',
  quit: 'Quit',
  cancel: 'Cancel',
  quitTitle: 'Quit BirdCoder?',
  ...
  hideApplication: '隐藏 BirdCoder',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 BirdCoder',
  openApplication: '打开 BirdCoder',
  quit: '退出',
  cancel: '取消',
  quitTitle: '退出 BirdCoder？',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'BirdCoder 无法使用',
  fatalSummary: '应用无法启动或已意外停止。',
  startupAddressInUse: '有其他正在运行的 BirdCoder（如其他 dsh web、桌面端），无法同时启动，请退出其他正在运行的 BirdCoder 后重启。',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'BirdCoder v{version} 下载完成',
