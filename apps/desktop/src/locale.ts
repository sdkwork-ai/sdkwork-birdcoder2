...
export const en = {
  ...
  startupLoading: 'Starting BirdCoder…',
...
export const zh = {
  application: '应用',
  startupFailed: 'BirdCoder 无法启动',
  startupLoading: '正在启动 BirdCoder…',
  ...
  pluginWindowTitle: 'BirdCoder — 桌面插件',
