...
LangString INSTALLER_RUNNING ${LANG_ENGLISH} "BirdCoder is running. Quit it from the system tray and try again."
LangString INSTALLER_RUNNING ${LANG_SIMPCHINESE} "BirdCoder 正在运行，请先在系统托盘中退出应用后重试。"
