...
; FORK DIVERGENCE (AGENTS.md, "Desktop shell display copy"): these are install-time
; display surfaces, so they name the product BirdCoder. Upstream-owned source text
; elsewhere keeps its upstream wording on purpose, to keep merges low-conflict.
LangString INSTALLER_LAUNCH_FAILED ${LANG_ENGLISH} "BirdCoder could not be launched. Retry, or clear Launch now and close the installer."
LangString INSTALLER_LAUNCH_FAILED ${LANG_SIMPCHINESE} "无法启动 BirdCoder。请重试，或取消勾选立即启动后关闭安装程序。"
...
LangString INSTALLER_RUNNING ${LANG_ENGLISH} "BirdCoder is running. Close the application, then run this installer again."
LangString INSTALLER_RUNNING ${LANG_SIMPCHINESE} "BirdCoder 正在运行。请先关闭应用，再重新运行安装程序。"
...
LangString INSTALLER_PATH_OWNERSHIP ${LANG_ENGLISH} "Choose an empty folder or the registered BirdCoder installation folder."
LangString INSTALLER_PATH_OWNERSHIP ${LANG_SIMPCHINESE} "请选择空文件夹，或 BirdCoder 原来的安装目录。"
LangString INSTALLER_PATH_WRITABLE ${LANG_ENGLISH} "This location is not writable. Choose another folder."
LangString INSTALLER_PATH_WRITABLE ${LANG_SIMPCHINESE} "无法写入此位置，请选择其他文件夹。"
