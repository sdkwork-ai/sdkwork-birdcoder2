...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-client-ui-app-modes', bundlePath: 'packages/client/ui-app-modes/lib/client.js', url: '/plugins/ui-app-modes.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-connection', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-layout', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-api-remotes'] },
  { id: '@deepseek-ai/dsh-client-ui-env', bundlePath: 'packages/client/ui-env/lib/client.js', url: '/plugins/ui-env.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-ui-settings'] },
  { id: '@deepseek-ai/dsh-client-ui-settings-menu', bundlePath: 'packages/client/ui-settings-menu/lib/client.js', url: '/plugins/ui-settings-menu.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-connection', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-client-ui-slots', '@deepseek-ai/dsh-client-ui-theme', '@deepseek-ai/dsh-client-locale'] },
  { id: '@deepseek-ai/dsh-client-ui-iam', bundlePath: 'packages/client/ui-iam/lib/client.js', url: '/plugins/ui-iam.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-slots', '@deepseek-ai/dsh-client-ui-env', '@deepseek-ai/dsh-client-ui-theme', '@deepseek-ai/dsh-client-ui-layout', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-settings-menu'] },
  { id: '@deepseek-ai/dsh-client-ui-appstore', bundlePath: 'packages/client/ui-appstore/lib/client.js', url: '/plugins/ui-appstore.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-env', '@deepseek-ai/dsh-client-ui-iam'] },
  { id: '@deepseek-ai/dsh-client-ui-knowledge', bundlePath: 'packages/client/ui-knowledge/lib/client.js', url: '/plugins/ui-knowledge.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-env', '@deepseek-ai/dsh-client-ui-iam'] },
  { id: '@deepseek-ai/dsh-client-ui-drive', bundlePath: 'packages/client/ui-drive/lib/client.js', url: '/plugins/ui-drive.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-env', '@deepseek-ai/dsh-client-ui-iam'] },
  { id: '@deepseek-ai/dsh-client-ui-generations-image', bundlePath: 'packages/client/ui-generations-image/lib/client.js', url: '/plugins/ui-generations-image.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-env', '@deepseek-ai/dsh-client-ui-iam'] },
  { id: '@deepseek-ai/dsh-client-ui-generations-video', bundlePath: 'packages/client/ui-generations-video/lib/client.js', url: '/plugins/ui-generations-video.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-env', '@deepseek-ai/dsh-client-ui-iam'] },
  { id: '@deepseek-ai/dsh-client-ui-generations-assets', bundlePath: 'packages/client/ui-generations-assets/lib/client.js', url: '/plugins/ui-generations-assets.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes', '@deepseek-ai/dsh-client-ui-env', '@deepseek-ai/dsh-client-ui-iam'] },
  { id: '@deepseek-ai/dsh-client-ui-assets', bundlePath: 'packages/client/ui-assets/lib/client.js', url: '/plugins/ui-assets.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes'] },
  { id: '@deepseek-ai/dsh-client-ui-token-plan', bundlePath: 'packages/client/ui-token-plan/lib/client.js', url: '/plugins/ui-token-plan.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-app-modes'] },
...
export function installAssembledBootEnv(): void {
  beforeEach(() => {
    ...
    document.title = 'BirdCoder'
    vi.stubGlobal('ResizeObserver', ResizeObserverStub)
    vi.stubGlobal('requestAnimationFrame', (callback: FrameRequestCallback) =>
      setTimeout(() => { callback(0) }, 0) as unknown as number)
    vi.stubGlobal('cancelAnimationFrame', (id: number) => { clearTimeout(id) })
    vi.stubGlobal('fetch', vi.fn(() => Promise.reject(new Error('assembled fixture forbids network fetch'))))
  })
