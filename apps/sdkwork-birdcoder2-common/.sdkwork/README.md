# SDKWork Application Workspace

This `.sdkwork/` directory is source-controlled workspace metadata for `sdkwork-birdcoder2-common`.

It is governed by `../../sdkwork-specs/SDKWORK_WORKSPACE_SPEC.md`.

## Application Identity

- App: sdkwork-birdcoder2-common
- Type: shared-package-family (cross-architecture TypeScript package family)
- Domain: ai
...
- Architecture standard: `../../sdkwork-specs/APP_COMPOSITION_SPEC.md`
