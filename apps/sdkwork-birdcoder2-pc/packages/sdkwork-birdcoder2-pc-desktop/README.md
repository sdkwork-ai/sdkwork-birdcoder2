# @sdkwork/birdcoder2-pc-desktop

Tauri/Electron native host: window/tray, deep links, clipboard, file dialogs, updater, local service lifecycle, tablet packaging.
