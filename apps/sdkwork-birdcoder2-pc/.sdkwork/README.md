...
This `.sdkwork/` directory is source-controlled workspace metadata for `sdkwork-birdcoder2-pc`.

It is governed by `../../sdkwork-specs/SDKWORK_WORKSPACE_SPEC.md`.

## Application Identity

- App: sdkwork-birdcoder2-pc
- Type: react-tauri-app (PC browser + Tauri desktop)
- Domain: ai
...
- Architecture standard: `../../sdkwork-specs/APP_PC_ARCHITECTURE_SPEC.md`
