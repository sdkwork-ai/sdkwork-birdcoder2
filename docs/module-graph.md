...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_common_app_header["client-ui-sdkwork-common-app-header"]
    pkg_client_ui_conversation["client-ui-conversation"]
    pkg_client_ui_course["client-ui-sdkwork-course"]
  ...
  pkg_client_ui_common_app_header --> pkg_client_connection
  pkg_client_ui_common_app_header --> pkg_client_locale
  pkg_client_ui_common_app_header --> pkg_client_runtime
  pkg_client_ui_common_app_header --> pkg_client_ui_layout
  pkg_client_ui_common_app_header --> pkg_client_ui_slots
  pkg_client_ui_common_app_header --> pkg_invariants
  ...
  pkg_client_ui_settings_menu --> pkg_client_ui_renderer
  ...
  pkg_client_ui_iam --> pkg_client_ui_renderer
  ...
  pkg_client_ui_appstore --> pkg_client_ui_theme
  pkg_client_ui_appstore --> pkg_invariants
  pkg_client_ui_course --> pkg_client_locale
  pkg_client_ui_course --> pkg_client_runtime
  pkg_client_ui_course --> pkg_client_ui_app_modes
  pkg_client_ui_course --> pkg_client_ui_env
  pkg_client_ui_course --> pkg_client_ui_iam
  pkg_client_ui_course --> pkg_client_ui_layout
  pkg_client_ui_course --> pkg_client_ui_primitives
  pkg_client_ui_course --> pkg_client_ui_slots
  pkg_client_ui_course --> pkg_client_ui_theme
  pkg_client_ui_course --> pkg_invariants
  ...
  pkg_client_ui_drive --> pkg_client_ui_theme
  ...
  pkg_client_ui_generations_assets --> pkg_client_ui_theme
  ...
  pkg_client_ui_generations_image --> pkg_client_ui_theme
  ...
  pkg_client_ui_generations_video --> pkg_client_ui_theme
  ...
  pkg_client_ui_knowledge --> pkg_client_ui_theme
  ...
  pkg_client_ui_token_plan --> pkg_client_ui_theme
...
| [`client-ui-sdkwork-common-app-header`](../packages/client/ui-sdkwork-common-app-header) | `client` | [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-settings-general`](../packages/client/ui-settings-general) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-sdkwork-app-modes`](../packages/client/ui-sdkwork-app-modes), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants), [`settings`](../packages/settings/settings) |
| [`client-ui-sdkwork-settings-menu`](../packages/client/ui-sdkwork-settings-menu) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-sdkwork-app-modes`](../packages/client/ui-sdkwork-app-modes), [`client-ui-primitives`](../packages/client/ui-primitives), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-slots`](../packages/client/ui-slots), [`client-ui-theme`](../packages/client/ui-theme), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-sdkwork-iam`](../packages/client/ui-sdkwork-iam) | `client` | [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-sdkwork-app-modes`](../packages/client/ui-sdkwork-app-modes), [`client-ui-sdkwork-env`](../packages/client/ui-sdkwork-env), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-primitives`](../packages/client/ui-primitives), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-sdkwork-settings-menu`](../packages/client/ui-sdkwork-settings-menu), [`client-ui-slots`](../packages/client/ui-slots), [`client-ui-theme`](../packages/client/ui-theme), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-sdkwork-feedback`](../packages/client/ui-sdkwork-feedback) | `client` | [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-sdkwork-env`](../packages/client/ui-sdkwork-env), [`client-ui-sdkwork-iam`](../packages/client/ui-sdkwork-iam), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-primitives`](../packages/client/ui-primitives), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-sdkwork-settings-menu`](../packages/client/ui-sdkwork-settings-menu), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
